<div>
        ...
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
            ...
            <li class="mr-2" role="presentation">
                <button class="inline-block p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300
                    ...
                    id="academic-cursus-tab" data-tabs-target="#academic-cursus" type="button" role="tab" aria-controls="academic-cursus" aria-selected="true"
                >
                    Parcours académique
                </button>
            </li>
    ...
    <div id="myTabContent" class="mx-auto flex">
        ...
        <div class="bg-gray-50 rounded-lg dark:bg-gray-800 w-full flex justify-center " id="academic-cursus" role="tabpanel" aria-labelledby="academic-cursus-tab">
